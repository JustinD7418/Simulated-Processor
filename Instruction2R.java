...
public class Instruction2R extends Instruction{
	...
	Instruction2R(String opCode, int rs, int rd, String alu, int imm){
		op = opCode;
		registerSource = rs;
		registerDest = rd;
		ALUOp = alu;
	...
	Instruction2R(String opCode, int rs, int rd, int imm){
		op = opCode;
		registerSource = rs;
		registerDest = rd;
		ALUOp = "0000";
	...
	public String toString() {
		...
		return immediateValueToBinary() + registerToBinary(registerSource) + ALUOp + registerToBinary(registerDest) + op + "11";
	}
